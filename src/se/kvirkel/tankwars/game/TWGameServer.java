...
import se.kvirkel.tankwars.network.TWNetworkServer;
...
public class TWGameServer {
	 ...
	 * The network server 
	 */
	private TWNetworkServer networkServer;
	/**
	 * the server updater 
	 * */
	private TWServerUpdater updater;
	/** 
	 * The active map 
	 */
	...
	/**
	 * Constructor, create a server
	 * @param mapName the map that the use choose
